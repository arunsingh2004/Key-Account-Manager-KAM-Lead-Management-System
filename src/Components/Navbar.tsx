...
export const Navbar = () => {
  ...
  return (
    <div className="px-4 py-5 mx-auto sm:max-w-screen-full md:max-w-full lg:max-w-screen-full bg-yellow-50 md:px-24 lg:px-12 ">
      <div className="relative flex items-center justify-between">
        ...
        <ul className="flex items-center hidden space-x-8 lg:flex">
          {!userId ? (
            <>
              <Link
                className="ml-auto py-3 px-6 rounded-full text-center transition bg-gradient-to-b from-yellow-200 to-yellow-300 hover:to-red-300 active:from-yellow-500 focus:from-red-400 md:px-12"
                href="/sign-in"
              >
                Sign In
              </Link>
